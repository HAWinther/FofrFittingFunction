...
500     if (L< lmax_extrap_highl) &
    ...
    !=======================================================================
    !write(*,*) 'Fix matter power data'
    !do itf = 1, PK_data%num_z
    !  zz = PK_data%Redshifts(itf)
    !  do i=1, PK_data%num_k
    !    kk = exp(PK_data%log_kh(i))
    !    if(kk>1.0)then
    !      PK_data%nonlin_ratio(i,itf) = PK_data%nonlin_ratio(i,itf) / 10.d0
    !      !PK_data%matpower(i,itf) = PK_data%matpower(i,itf) * 10.d0
    !    endif
    !  end do
    !end do
    !=======================================================================
