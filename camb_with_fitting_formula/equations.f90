    ...
    ! Hu-Sawkicy modifications
    if(CP%fofr0 > 0.0)then
      rescalefactor = dsqrt(pofk_enhancement_linear(1.0/y(1)-1.0,CP%fofr0, EV%k_buf / (CP%H0/100.0)))

      ! Rescale CDM, baryons, mass_nu, total
      Arr(2:3) = Arr(2:3) * rescalefactor
      Arr(6:8) = Arr(6:8) * rescalefactor
    endif
